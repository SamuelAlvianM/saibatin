...
class AktaKelahiranNikTidakAdaController extends Controller
{   
    ...
    {
        $pelayananID    = '2'; /*m_setup_pelayanan*/
        ...
        if(!$data_OperasionalWaktu):
            ...
            return view('fronts.permohonans.aktakelahiranNikTidakAda', ['id'=>$urlRoute,'key'=>$key,'modal'=>$modal,'prm1'=>$prm1,'prm2'=>$prm2,'prm3'=>$prm3]);
        endif;
    }
    ...
    {   
        ...
        if($recaptchaRes->isSuccess()):
            ...
            /* setup 1 [start] */
            $permohonanType = 'kelahiran_1';
            $permohonanKet  = 'Akta Kelahiran (Blm Ada NIK)';
            $permohonanInitial  = 'AKL01';
            /* setup 1 [end] */
    	            ...
    	            if($pemohonnik):
    	                if($act == "ins"):
    	                	try {
    	                        ...
    	                        $dataprepcv = new Kelahiran1Model([
    	                        ...
    	                        $isExistQuery= Kelahiran1Model::whereIn('progress_status', ['2','3'])->where([['pemohon_nik','=',$pemohonnik],['status','=','1']]);
    	                        if($isExistQuery->count()<=0):
    		                        ...
    		                        if($savedata):
                                        ...
                                        $PermohonanData     = Kelahiran1Model::where([['nomorPermohonan',$genNoPermohonan]])->get()->first();
    	                ...
    	                elseif($request->get('act') == "upd"):
                            try {
                                $data = Kelahiran1Model::find($request->get('key'));
                                ...
                                if($updatedata):
                                    ...
                                    if($prgsts=='0'):
                                        $ListFieldOfTable_init      = new Kelahiran1Model;
                                        ...
                                        $datamaskingMass= Kelahiran1Model::find($request->get('key'));
    ...
    {   
        ...
        $data   = Kelahiran1Model::where([['nomorPermohonan','=',$nomorPermohonan]])->get()->first();
        $output = array(
    ...
    public function genPDF($permohonanType,$permohonanID) {
        $data   = Kelahiran1Model::where([['nomorPermohonan','=',$permohonanID]])->get()->first();
        ...
        $pdf = \PDF::loadView('fronts.permohonans.aktakelahiranNikTidakAdaPDF', $output);
