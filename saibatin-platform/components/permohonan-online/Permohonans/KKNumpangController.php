...
{   
    ...
    {   
        $pelayananID    = '6'; /*m_setup_pelayanan*/
        ...
        if(!$data_OperasionalWaktu):
            ...
            return view('fronts.permohonans.kknumpang', ['id'=>$urlRoute,'key'=>$key,'modal'=>$modal,'prm1'=>$prm1,'prm2'=>$prm2,'prm3'=>$prm3]);
        endif;
    }
    ...
    public function postdata(Request $request)
    {
        ...
        if($recaptchaRes->isSuccess()):
            ...
            /* setup 1 [start] */
            $permohonanType = 'kknumpang';
            $permohonanKet  = 'KK Numpang';
            $permohonanInitial  = 'KKN01';
            /* setup 1 [end] */
            ...
            $kklama = $request->get('kklama');
            $kkygditempati = $request->get('kkygditempati');
            $nikygnumpangkk= $request->get('nikygnumpangkk');
            $alasannumpangkk= $request->get('alasannumpangkk');
            $filekklamax= $request->get('filekklamax');
            $filekkygditempatix= $request->get('filekkygditempatix');
            ...
            if($act=='ins'):
                $validation = Validator::make(
                    ...
                    ,[
                        ...
                        'kklama'        => 'required',
                        'kkygditempati' => 'required',
                        'nikygnumpangkk'=> 'required',
                        'alasannumpangkk'   => 'required',

                        'filekklamax'   => 'required',
                        'filekkygditempatix'   => 'required'
                    ]
                    ,[
                        'required'  => ':attribute'
                    ]
                ...
                if($validation->fails()):
                    ...
                    if($sessnik):
                        ...
                        if($act == "ins"):
                            try {
                                ...
                                $dataprepcv = new KKNumpangModel([
                                    ...
                                    'kk_kklama' => $kklama,
                                    'kk_kkygditempati' => $kkygditempati,
                                    'kk_nikygnumpangkk'    => $nikygnumpangkk,
                                    'kk_alasannumpangkk'    => $alasannumpangkk,
                                    'catatan_detail'=> $catatan,
                                    'syaratDok_KKLama'  => isset($filekklamax)?'uploads/'.$permohonanType.'/'.$genNoPermohonan.'/'.$filekklamax:'',
                                    'syaratDok_KKYgDitempati'  => isset($filekkygditempatix)?'uploads/'.$permohonanType.'/'.$genNoPermohonan.'/'.$filekkygditempatix:'',
                                ...
                                $isExistQuery= KKNumpangModel::whereIn('progress_status', ['2','3'])->where([['pemohon_nik','=',$pemohonnik],['status','=','1']]);
                                if($isExistQuery->count()<=0):
                                    ...
                                    if($savedata):
                                        ...
                                        $fileList  = ['filekklamax','filekkygditempatix','filependukung1x'];
                                        ...
                                        $PermohonanData     = KKNumpangModel::where([['nomorPermohonan',$genNoPermohonan]])->get()->first();
                        ...
                        elseif($request->get('act') == "upd"):
                            try {
                                $data = KKNumpangModel::find($request->get('key'));
                                ...
                                if($updatedata):
                                    ...
                                    if($prgsts=='0'):
                                        $ListFieldOfTable_init      = new KKNumpangModel;
                                        ...
                                        $datamaskingMass= KKNumpangModel::find($request->get('key'));
    ...
    {   
        ...
        $data   = KKNumpangModel::where([['nomorPermohonan','=',$nomorPermohonan]])->get()->first();
        $output = array(
            ...
            ,'kklama'    => $data->kk_kklama
            ,'kkygditempati'     => $data->kk_kkygditempati
            ,'nikygnumpangkk'    => $data->kk_nikygnumpangkk
            ,'alasannumpangkk'   => $data->kk_alasannumpangkk
            ,'filekklama'   => $data->syaratDok_KKLama
            ,'filekkygditempati'   => $data->syaratDok_KKYgDitempati
    ...
    public function genPDF($permohonanType,$permohonanID) {
        $data   = KKNumpangModel::where([['nomorPermohonan','=',$permohonanID]])->get()->first();
        $data_kkNumpangAlasan = OptionModel::where([['option_val','=',$data->kk_alasannumpangkk],['option_group','=','kkNumpangAlasan'],['status','=','1']])->get()->first();
        $output = array(
            'permohonanid'  => $data->nomorPermohonan
            ,'pemohonnik'   => $data->pemohon_nik
            ,'pemohonnama'  => $data->pemohon_nama
            ...
            ,'kkygditempati'     => $data->kk_kkygditempati
            ,'nikygnumpangkk'    => $data->kk_nikygnumpangkk
            ,'alasannumpangkknm' => $data->kk_alasannumpangkk
            ,'alasannumpangkkval'=> $data_kkNumpangAlasan->option_name
            ,'filekklama'   => ($data->syaratDok_KKLama)?'ADA':'-'
            ,'filekkygditempati'   => ($data->syaratDok_KKYgDitempati)?'ADA':'-'
        ...
        $pdf = \PDF::loadView('fronts.permohonans.kknumpangPDF', $output);
