              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                <div className="space-y-2 animate-in slide-in-from-top-2 fade-in duration-300">
                  <Label htmlFor="nikbayi" className="flex items-center justify-between">
                    <span>NIK Bayi *</span>
                    <span className={cn("text-xs font-normal", formData.nikbayi.length === 16 ? "text-success" : "text-muted-foreground")}>
                ...
                {uploadedFiles.keteranganlahir ? (
                  <div className="relative group">
                    <div className="flex items-center justify-between p-4 border-2 border-success rounded-lg bg-success/10 transition-all duration-300 hover:shadow-md">
                      <div className="flex items-center gap-3">
                        ...
                        <div>
                          <p className="text-sm font-medium text-success">{uploadedFiles.keteranganlahir.name}</p>
                          <p className="text-xs text-success">Berhasil diupload</p>
                        </div>
                      </div>
                      <Button
                  ...
                  <div className="relative">
                    <Input
                      ...
                      className={cn(
                        "cursor-pointer transition-all duration-200 hover:border-primary",
                        touchedFields.has("fileketeranganlahirx") && !formData.fileketeranganlahirx && "border-destructive focus:border-destructive"
                      )}
                    />
                ...
                {uploadedFiles.ktpsaksi1 ? (
                  <div className="relative group">
                    <div className="flex items-center justify-between p-4 border-2 border-success rounded-lg bg-success/10 transition-all duration-300 hover:shadow-md">
                      <div className="flex items-center gap-3">
                        ...
                        <div>
                          <p className="text-sm font-medium text-success">{uploadedFiles.ktpsaksi1.name}</p>
                          <p className="text-xs text-success">Berhasil diupload</p>
                        </div>
                      </div>
                      <Button
                  ...
                  <div className="relative">
                    <Input
                      ...
                      className={cn(
                        "cursor-pointer transition-all duration-200 hover:border-primary",
                        touchedFields.has("filektpsaksi1x") && !formData.filektpsaksi1x && "border-destructive focus:border-destructive"
                      )}
                    />
                ...
                {uploadedFiles.ktpsaksi2 ? (
                  <div className="relative group">
                    <div className="flex items-center justify-between p-4 border-2 border-success rounded-lg bg-success/10 transition-all duration-300 hover:shadow-md">
                      <div className="flex items-center gap-3">
                        ...
                        <div>
                          <p className="text-sm font-medium text-success">{uploadedFiles.ktpsaksi2.name}</p>
                          <p className="text-xs text-success">Berhasil diupload</p>
                        </div>
                      </div>
                      <Button
                  ...
                  <div className="relative">
                    <Input
                      ...
                      className={cn(
                        "cursor-pointer transition-all duration-200 hover:border-primary",
                        touchedFields.has("filektpsaksi2x") && !formData.filektpsaksi2x && "border-destructive focus:border-destructive"
                      )}
                    />
                  ...
                  <div className="relative group">
                    <div className="flex items-center justify-between p-4 border-2 border-success rounded-lg bg-success/10 transition-all duration-300 hover:shadow-md">
                      <div className="flex items-center gap-3">
                        ...
                        <div>
                          <p className="text-sm font-medium text-success">{uploadedFiles.ktpayah.name}</p>
                          <p className="text-xs text-success">Berhasil diupload</p>
                        </div>
                      </div>
                      <Button
                  ...
                  <div className="relative group">
                    <div className="flex items-center justify-between p-4 border-2 border-success rounded-lg bg-success/10 transition-all duration-300 hover:shadow-md">
                      <div className="flex items-center gap-3">
                        ...
                        <div>
                          <p className="text-sm font-medium text-success">{uploadedFiles.ktpibu.name}</p>
                          <p className="text-xs text-success">Berhasil diupload</p>
                        </div>
                      </div>
                      <Button
