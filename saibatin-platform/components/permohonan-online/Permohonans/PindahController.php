...
{   
    ...
    {
        $pelayananID    = '13'; /*m_setup_pelayanan*/
        ...
        if(!$data_OperasionalWaktu):
            ...
            return view('fronts.permohonans.pindah', ['id'=>$urlRoute,'key'=>$key,'modal'=>$modal,'prm1'=>$prm1,'prm2'=>$prm2,'prm3'=>$prm3]);
        endif;
    }
    ...
    {   
        ...
        if($recaptchaRes->isSuccess()):
            ...
            /* setup 1 [start] */
            $permohonanType = 'pindah';
            $permohonanKet  = 'Perpindahan Penduduk';
            $permohonanInitial  = 'PPD01';
            /* setup 1 [end] */
            ...
            $klasifikasikepindahan  = $request->get('klasifikasikepindahan');
            $jeniskepindahan= $request->get('jeniskepindahan');
            $nikygpindah    = $request->get('nikygpindah');
            ...
            if($act=='ins'):
                $validation = Validator::make(
                    ...
                    ,[
                        ...
                        'klasifikasikepindahan'    => 'required',
                        'jeniskepindahan'    => 'required',
                        'nikygpindah'    => 'required',
    	        ...
    	        if($validation->fails()):
    	            ...
    	            if($sessnik):
    	                ...
    	                if($act == "ins"):
    	                	try {
                                ...
                                $dataprepcv = new PindahModel([
                                    ...
                                    'dataPindah_klasifikasikepindahan' => $klasifikasikepindahan,
                                    'dataPindah_jeniskepindahan'=> $jeniskepindahan,
                                    'dataPindah_yangAkanPindah' => $nikygpindah,
                                    'dataPindah_alasanPindah'   => $alasanpindah,
                                    'dataPindah_alamat'     => $alamat,
                                    'dataPindah_provinsi'   => $provinsi,
                                    'dataPindah_kabupaten'  => $kabupaten,
                                    'dataPindah_kecamatan'  => $kecamatan,
                                    'dataPindah_kelurahan'  => $kelurahan,
                                    'dataPindah_rt' => $rt,
                                    'dataPindah_rw' => $rw,
                                ...
                                $isExistQuery= PindahModel::whereIn('progress_status', ['2','3'])->where([['pemohon_nik','=',$pemohonnik],['status','=','1']]);
                                if($isExistQuery->count()<=0):
                                    ...
                                    if($savedata):
                                        ...
                                        $fileList  = ['filekkx','filependukung1x','filependukung2x'];
                                        ...
                                        $PermohonanData     = PindahModel::where([['nomorPermohonan',$genNoPermohonan]])->get()->first();
    	                ...
    	                elseif($request->get('act') == "upd"):
                            try {
                                $data = PindahModel::find($request->get('key'));
                                ...
                                if($updatedata):
                                    ...
                                    if($prgsts=='0'):
                                        $ListFieldOfTable_init      = new PindahModel;
                                        ...
                                        $datamaskingMass= PindahModel::find($request->get('key'));
    ...
    {   
        ...
        $data   = PindahModel::where([['nomorPermohonan','=',$nomorPermohonan]])->get()->first();
        ...
        $output = array(
            ...
            ,'klasifikasikepindahan'   => $data->dataPindah_klasifikasikepindahan
            ,'jeniskepindahan'   => $data->dataPindah_jeniskepindahan
            ,'nikygpindah'   => $data->dataPindah_yangAkanPindah
            ,'alasanpindah'   => $data->dataPindah_alasanPindah
            ,'alamat'   => $data->dataPindah_alamat
            ,'provinsi'     => $data->dataPindah_provinsi
            ,'kabupaten'=> $data->dataPindah_kabupaten
            ,'kecamatan'=> $data->dataPindah_kecamatan
            ,'kelurahan'=> $data->dataPindah_kelurahan
            ,'rt'   => $data->dataPindah_rt
            ,'rw'   => $data->dataPindah_rw
    ...
    public function genPDF($permohonanType,$permohonanID) {
        $data   = PindahModel::where([['nomorPermohonan','=',$permohonanID]])->get()->first();
        $data_pindahPendudukKlasifikasi = OptionModel::where([['option_val','=',$data->dataPindah_klasifikasikepindahan],['option_group','=','pindahPendudukKlasifikasi'],['status','=','1']])->get()->first();
        $data_pindahPendudukJenis       = OptionModel::where([['option_val','=',$data->dataPindah_jeniskepindahan],['option_group','=','pindahPendudukJenis'],['status','=','1']])->get()->first();
        $output = array(
            'permohonanid'  => $data->nomorPermohonan
            ,'pemohonnik'   => $data->pemohon_nik
            ,'pemohonnama'  => $data->pemohon_nama
            ...
            ,'pemohonhp'    => $data->pemohon_hp
            ,'pemohonemail' => $data->pemohon_email
            ,'klasifikasikepindahan'   => $data_pindahPendudukKlasifikasi->option_name
            ,'jeniskepindahan'   => $data_pindahPendudukJenis->option_name
            ,'nikygpindah'   => $data->dataPindah_yangAkanPindah
            ,'alasanpindah'   => $data->dataPindah_alasanPindah
            ,'alamat'   => $data->dataPindah_alamat
            ,'provinsi'     => $data->dataPindah_provinsi
        ...
        $pdf = \PDF::loadView('fronts.permohonans.pindahPDF', $output);
