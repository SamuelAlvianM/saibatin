        ...
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-10 lg:gap-8">
          ...
          <div className="lg:col-span-5 space-y-5">
            ...
            <p className="text-sm leading-relaxed max-w-md">
              Portal layanan administrasi kependudukan dan pencatatan sipil Kabupaten
              Pesisir Barat. Melayani masyarakat secara profesional, akuntabel, dan prima.
            </p>
          </div>
          ...
          <div className="lg:col-span-4">
            <div className="rounded-2xl border border-white/10 bg-white/5 p-5">
              <h4 className="text-white font-semibold mb-4 text-sm uppercase tracking-wider">Kantor Kami</h4>
              <ul className="space-y-3 text-sm">
                <li className="flex items-start gap-3">
                  ...
                  <span>
                    ...
                    <br />Kec. Pesisir Tengah, Kabupaten Pesisir Barat, Lampung
                  </span>
                </li>
      ...
      <div className="border-t border-white/10">
        <div className="container mx-auto px-4 md:px-8 lg:px-16 py-5">
          <div className="flex flex-col md:flex-row justify-between items-center gap-3 text-xs text-slate-500">
            <p>
              © {year} <span className="text-slate-300 font-medium">SAIBATIN</span> — Disdukcapil Kabupaten Pesisir Barat
            </p>
