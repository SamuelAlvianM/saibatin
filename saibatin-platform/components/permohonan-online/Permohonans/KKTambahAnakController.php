...
class KKTambahAnakController extends Controller
{   
    ...
    {   
        $pelayananID    = '7'; /*m_setup_pelayanan*/
        ...
        if(!$data_OperasionalWaktu):
            ...
            return view('fronts.permohonans.kktambahanak', ['id'=>$urlRoute,'key'=>$key,'modal'=>$modal,'prm1'=>$prm1,'prm2'=>$prm2,'prm3'=>$prm3]);
        endif;
    }
    ...
    public function postdata(Request $request)
    {
        ...
        if($recaptchaRes->isSuccess()):
            ...
            /* setup 1 [start] */
            $permohonanType = 'kktambahanak';
            $permohonanKet  = 'KK Tambah Anak';
            $permohonanInitial  = 'KKT01';
            /* setup 1 [end] */
            ...
            $namaanggotakeluarga   = $request->get('namaanggotakeluarga');
            ...
            $fileaktax  = $request->get('fileaktax');
                    ...
                    if($sessnik):
                        ...
                        if($act == "ins"):
                            try {
                                ...
                                $dataprepcv = new KKTambahAnakModel([
                                    ...
                                    'kk_namaanggotakeluarga'    => $namaanggotakeluarga,
                                    ...
                                    'syaratDok_Akta' => isset($fileaktax)?'uploads/'.$permohonanType.'/'.$genNoPermohonan.'/'.$fileaktax:'',
                                ...
                                $isExistQuery= KKTambahAnakModel::whereIn('progress_status', ['2','3'])->where([['pemohon_nik','=',$pemohonnik],['status','=','1']]);
                                if($isExistQuery->count()<=0):
                                    ...
                                    if($savedata):
                                        ...
                                        $fileList  = ['filekkx','fileaktax','filebukunikahx'];
                                        ...
                                        $PermohonanData     = KKTambahAnakModel::where([['nomorPermohonan',$genNoPermohonan]])->get()->first();
                        ...
                        elseif($request->get('act') == "upd"):
                            try {
                                $data = KKTambahAnakModel::find($request->get('key'));
                                ...
                                if($updatedata):
                                    ...
                                    if($prgsts=='0'):
                                        $ListFieldOfTable_init      = new KKTambahAnakModel;
                                        ...
                                        $datamaskingMass= KKTambahAnakModel::find($request->get('key'));
    ...
    {   
        ...
        $data   = KKTambahAnakModel::where([['nomorPermohonan','=',$nomorPermohonan]])->get()->first();
        ...
        $output = array(
            ...
            ,'namaanggotakeluarga'  => $data->kk_namaanggotakeluarga
    ...
    public function genPDF($permohonanType,$permohonanID) {
        $data   = KKTambahAnakModel::where([['nomorPermohonan','=',$permohonanID]])->get()->first();
        ...
        $output = array(
            ...
            ,'jeniskelaminval'  => $data_jenkel->option_name
            ,'catatan'      => ($data->catatan_detail)?$data->catatan_detail:'-'
            ,'filekk'       => ($data->syaratDok_KK)?'ADA':'-'
            ,'fileakta'     => ($data->syaratDok_Akta)?'ADA':'-'
        ...
        $pdf = \PDF::loadView('fronts.permohonans.kktambahanakPDF', $output);
