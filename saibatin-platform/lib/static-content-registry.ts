  ...
  },
  {
    ...
    defaults: {
      organisasi: [
        ...
        { jabatan: "Sub Bag Umum dan Kepegawaian", nama: "-", parent: "Sekretaris" },
        { jabatan: "Sub Bag Penyusunan Program dan Keuangan", nama: "-", parent: "Sekretaris" },
        { jabatan: "Bidang Pelayanan Pendaftaran Penduduk", nama: "-", parent: "Kepala Dinas" },
        { jabatan: "Seksi Identitas Penduduk", nama: "-", parent: "Bidang Pelayanan Pendaftaran Penduduk" },
        { jabatan: "Seksi Pindah Datang", nama: "-", parent: "Bidang Pelayanan Pendaftaran Penduduk" },
        { jabatan: "Seksi Pendataan Penduduk", nama: "-", parent: "Bidang Pelayanan Pendaftaran Penduduk" },
        { jabatan: "Bidang Pelayanan Pencatatan Sipil", nama: "-", parent: "Kepala Dinas" },
        { jabatan: "Seksi Kelahiran", nama: "-", parent: "Bidang Pelayanan Pencatatan Sipil" },
        { jabatan: "Seksi Perkawinan dan Perceraian", nama: "-", parent: "Bidang Pelayanan Pencatatan Sipil" },
        { jabatan: "Seksi Perubahan Status Anak, Pewarganegaraan dan Kematian", nama: "-", parent: "Bidang Pelayanan Pencatatan Sipil" },
        { jabatan: "Bidang Pengelolaan Informasi Administrasi Kependudukan", nama: "-", parent: "Kepala Dinas" },
        { jabatan: "Seksi Sistem Informasi Administrasi Kependudukan", nama: "-", parent: "Bidang Pengelolaan Informasi Administrasi Kependudukan" },
        { jabatan: "Seksi Pengelolaan dan Penyajian Data Kependudukan", nama: "-", parent: "Bidang Pengelolaan Informasi Administrasi Kependudukan" },
        { jabatan: "Seksi Kerjasama dan Inovasi Pelayanan", nama: "-", parent: "Bidang Pengelolaan Informasi Administrasi Kependudukan" },
      ],
    },
  },
  {
