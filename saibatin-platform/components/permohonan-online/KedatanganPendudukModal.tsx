...
export default function KonsolidasiUpdateDataModal({
  open,
  onOpenChange,
  mode = "create",
  permohonanId,
}: KonsolidasiUpdateDataModalProps) {
  ...
  const alasanOptions = [
    { value: "perubahan_data_kk", label: "Perubahan Data KK" },
    { value: "perbaikan_nik", label: "Perbaikan NIK" },
    { value: "perubahan_nama", label: "Perubahan Nama" },
    { value: "perubahan_alamat", label: "Perubahan Alamat" },
  ...
  const validateField = (
    ...
    switch (field) {
      ...
      case "alasankonsolidasidata":
        return validateRequired(value, "Alasan Konsolidasi Data");
      case "filektpx":
        return validateRequired(value, "Upload KTP");
      case "filekkx":
  ...
  const validateStep = (step: number): { isValid: boolean; errors: string[] } => {
    ...
    switch (step) {
      case 1:
        ...
        break;
      case 2:
        fieldsToValidate = ["namakepalakeluarga", "alasankonsolidasidata"];
        break;
      case 3:
        fieldsToValidate = ["filektpx", "filekkx"];
        break;
    }
    ...
    try {
      ...
      if (data) {
        setFormData({
          ...
          alasankonsolidasidata: data.alasankonsolidasidata || "",
          filektpx: data.filektp || "",
          filekkx: data.filekk || "",
  ...
  const removeFile = (fileType: "ktp" | "kk" | "pendukung") => {
    const fieldMap = {
      ktp: "filektpx",
      kk: "filekkx",
      pendukung: "filependukung1x",
  ...
  const getStepProgress = () => {
    const steps = [
      ...
      ["namakepalakeluarga", "alasankonsolidasidata"],
      ["filektpx", "filekkx"],
    ];
  ...
  const steps = [
    ...
    { step: 2, label: "Konsolidasi", icon: Database },
        ...
        <form onSubmit={handleSubmit} className="overflow-y-auto flex-1 px-1">
          <div className="space-y-4 py-4">
            ...
            >
              <div className="space-y-2 animate-in slide-in-from-top-2 fade-in duration-300">
                ...
                <Input
                  ...
                  onChange={(e) =>
                    handleInputChange("namakepalakeluarga", e.target.value)
                  }
              ...
              <div className="space-y-2 animate-in slide-in-from-top-2 fade-in duration-300 delay-100">
                <Label htmlFor="alasankonsolidasidata">
                  Alasan Konsolidasi Data *
                </Label>
                <Select
                  value={formData.alasankonsolidasidata}
                  onValueChange={(value) =>
                    handleInputChange("alasankonsolidasidata", value)
                  }
                >
                  <SelectTrigger className={getSelectClass("alasankonsolidasidata")}>
                    <SelectValue placeholder="Pilih alasan konsolidasi" />
                  </SelectTrigger>
                  <SelectContent>
                ...
                {showFieldError("alasankonsolidasidata")}
              </div>
            ...
            >
              {/* KTP Upload - Required */}
              <div className="space-y-2 animate-in slide-in-from-top-2 fade-in duration-300">
                <Label htmlFor="filektp" className="flex items-center gap-2">
