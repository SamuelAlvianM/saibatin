...
const sections: { title: string; links: { label: string; href: string }[] }[] = [
  ...
  },
  {
    ...
    links: [
      ...
      { label: 'Survey Kepuasan Masyarakat', href: '/media/survey-kepuasan' },
      { label: 'GIS Dukcapil', href: '/media/gis' },
      { label: 'Laporan Data Demografi', href: '/media/laporan-demografi' },
      { label: 'Demografi - Agama', href: '/media/demografi/agama' },
      { label: 'Demografi - Golongan Darah', href: '/media/demografi/golongan-darah' },
      { label: 'Demografi - Jenis Kelamin', href: '/media/demografi/jenis-kelamin' },
      { label: 'Demografi - Kepala Keluarga', href: '/media/demografi/kepala-keluarga' },
      { label: 'Demografi - Pendidikan', href: '/media/demografi/pendidikan' },
      { label: 'Demografi - Status Perkawinan', href: '/media/demografi/status-perkawinan' },
